        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 element-content">
              <h3>Design First</h3>
              <p>
                Design comes to life. Always thinking that the interface is the application, we devote sumptuous attention to intricate details.
              </p>
            </div>
            <div class="col-md-6 ">
          ...
          <div class="row">
            ...
            <div class="col-md-6 element-content">
              ...
              <p>
                We will continuously bring you new ways of 
thinking that promotes ideas that are fresh, 
on-trend and relevantto blend traditional 
...
and new media.
          ...
          <div class="row">
            <div class="col-md-6 element-content">
              ...
              <p>
                We are a small team and hence very agile
and fexible. So we make the “go-to market”
process quick, efcient and afordable.
              </p>
            </div>
            <div class="col-md-6 ">
              <div class="element-box pull-left">
